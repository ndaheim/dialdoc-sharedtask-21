...
PYTHON_EXE = "/u/daheim/miniconda3/bin/python3" # Add path to your python executable
SIS_COMMAND = [PYTHON_EXE, sys.argv[0]]
MAX_PARALLEL = 20
SGE_SSH_COMMANDS = [' source /u/standard/settings/sge_settings.sh; ']

def TODO():
  raise Exception("Has to be changed")

# Application specific settings
SCRIPT_ROOT = TODO() #"/u/daheim/sharedtask-dialdoc2021/scripts/subtask1/run_qa.py"
CRNN_PYTHON_EXE = PYTHON_EXE
CRNN_ROOT = RETURNN_ROOT
RECIPE_PATH = TODO() #'/u/daheim/sharedtask-dialdoc2021/.recipe_magic'
SEQ_UTILS_FILE = TODO() #'/u/daheim/sharedtask-dialdoc2021/scripts/subtask2/seq2seq_utils.py'
SCRIPTS_ROOT = TODO() #'/u/daheim/sharedtask-dialdoc2021/scripts'
...
DEFAULT_ENVIRONMENT_SET['PATH'] = '/usr/local/cuda-{cuda}/bin:'.format(**versions) + DEFAULT_ENVIRONMENT_SET['PATH']
